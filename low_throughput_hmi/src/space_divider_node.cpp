...
void act() {
    ...
    low_throughput_hmi::IntMap track_map_msg;
        ...
        MapRos<low_throughput_hmi::IntMap, int> track_map(track_map_msg);     
    //MapRos<low_throughput_hmi::IntMap, int> track_map(*divided_map);
...
void sceneCallback(low_throughput_hmi::Experiment msg) {
    ...
    low_throughput_hmi::IntMap divided_map_msg;
        ...
        divided_map= new MapRos<low_throughput_hmi::IntMap, int>(divided_map_msg);
