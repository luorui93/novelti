...
public:
    ...
    MapRos<low_throughput_hmi::IntMap, int> *my_map_, *track_map_;
    ...
    void sceneCallback(low_throughput_hmi::Experiment msg) {
        my_map_ = new MapRos<low_throughput_hmi::IntMap, int>(msg.mapa);
        ...
        track_map_= new MapRos<low_throughput_hmi::IntMap, int>(track_map_msg);
