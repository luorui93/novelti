...
#2 There are configurations when boundary walker can get stuck in an infinite loop:
    ...
    $ roslaunch novelti test_map_divider.launch map:=office4 debug:=1 px:=44 py:=72
    
    roslaunch novelti test_map_divider.launch map:=ak500inflated debug:=0 pdf_seed:=37 px:=46 py:=201
    roslaunch novelti test_map_divider.launch map:=ak500inflated debug:=0 pdf_seed:=454 px:=44 py:=200
    roslaunch novelti test_map_divider.launch map:=ak500inflated debug:=0 pdf_seed:=135 px:=52 py:=202
    roslaunch novelti test_map_divider.launch map:=ak500inflated debug:=0 pdf_seed:=30 px:=40 py:=200
    pdf_seed=41
41
