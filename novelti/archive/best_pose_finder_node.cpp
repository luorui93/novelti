...
MapRos<novelti::FloatMap,float>* reach_area;
...
void sceneCallback(novelti::Experiment msg) {
    ...
    reach_area   = new MapRos<novelti::FloatMap, float>(0,0,0);
...
int main(int argc, char **argv) {   
    ...
    pub_opt  = &pub1;
    #ifdef DEBUG_POSE_FINDER
        ros::Publisher pub2 = node->advertise<novelti::FloatMap>("/reach_area", 1, false); //not latched
        reach_area_pub  = &pub2;
    #endif
