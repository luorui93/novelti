...
def plot_mx94_vs_mx70_no_pois():
    ...
    pbr1 = PlottableBagRecord(dbase.getRecord(bags["mx94_no_pois"]["door1tolivroom1"][0]))
    pbr1.plotMaps(ax_map)
    pbr1.plotPathDistEntropy(ax_map, ax_dist1, ax_entr1, "#9999FF")
    pbr2 = PlottableBagRecord(dbase.getRecord(bags["mx94_no_pois"]["door1tolivroom1"][1]))
    pbr2.plotPathDistEntropy(ax_map, ax_dist1, ax_entr1, "#3333FF")
    pbr3 = PlottableBagRecord(dbase.getRecord(bags["mx94_no_pois"]["door1tolivroom1"][2]))
    pbr3.plotPathDistEntropy(ax_map, ax_dist1, ax_entr1, "#000099")
    ...
    #gp.plotArray(bags["mx70_no_pois"]["door1tolivroom1"], "red")
    ##gp.plotArray(bags["mx70_no_pois"]["livroom1tooffice1"], "blue")
    ##gp.plotArray(bags["mx70_no_pois"]["office1tobathroom1"], "blue")
    ##gp.plotArray(bags["mx70_no_pois"]["bathroom1tomusic1"], "blue")
    ##gp.plotArray(bags["mx70_no_pois"]["music1tobedroom1"], "blue")
