...
--sout "#transcode{vcodec=h264,vb=8192,acodec=mp3,ab=192,fps=24,scale=1}:duplicate{dst=std{access=file,mux=mp4,dst='/home/sd/Videos/alden_hall_experiment_desktop_$start_time.mp4'}}"
